const Home = props => (
  <svg
    aria-hidden="true"
    className="r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
    fill="#fff"
    viewBox="0 0 24 24"
    {...props}
  >
...
export { Home, Hashtag, Notification, Message, Bookmarks, List, Profile, More, Tweet, Twitter }
