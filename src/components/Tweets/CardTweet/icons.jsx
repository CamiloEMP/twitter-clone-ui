...
const Share = props => (
  <svg
    ...
    {...props}
  >
    <path d="m17.53 7.47-5-5a.749.749 0 0 0-1.06 0l-5 5a.749.749 0 1 0 1.06 1.06l3.72-3.72V15a.75.75 0 0 0 1.5 0V4.81l3.72 3.72c.146.147.338.22.53.22s.384-.072.53-.22a.749.749 0 0 0 0-1.06z" />
...
export { Reply, Retweet, Like, Share }
