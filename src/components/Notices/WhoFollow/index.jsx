...
const Verified = props => (
  <svg
    ...
    className="r-13v1u17 r-4qtqp9 r-yyyyoo r-1xvli5t r-9cviqr r-f9ja8p r-og9te1 r-bnwqim r-1plcrui r-lrvibr"
    viewBox="0 0 24 24"
    {...props}
  >
...
export const WhoFollow = () => {
  return (
    <Container>
      <div className={style.WhoFollow}>
        <h3>Who to Follow</h3>
        <a href="#">
          <div>
            <img
              alt="twitter freecodecampES"
              src="https://pbs.twimg.com/profile_images/1360453298067701766/QcG5XoYR_400x400.jpg"
            />
          </div>
          <div className={style.information}>
            <span>
              BYBIT{' '}
              <span>
                <Verified className={style.Verified} />
              </span>
            </span>
            <span>@ByBit_Official</span>
          </div>
        ...
        <a href="#">
          <div>
            <img
              alt="twitter FaztTech"
              src="https://pbs.twimg.com/profile_images/1403545185624203264/B80aezHw_400x400.jpg"
            />
          </div>
          <div className={style.information}>
            <span>
